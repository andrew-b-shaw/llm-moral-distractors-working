...
DATASETS = {
    "moralchoice_high_ambiguity": {
        ...
        "batch_submit_prompter_class": "MoralChoiceBatchSubmitPrompter",
        "scenario_loader": "csv",
    ...
    "reddit": {
        ...
        "batch_submit_prompter_class": "RedditBatchSubmitPrompter",
    ...
    "normbank": {
        ...
        "batch_submit_prompter_class": "NormBankBatchSubmitPrompter",
        "scenario_loader": "csv",
